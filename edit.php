    ...
    <form action="proses-edit.php" method="POST">
        ...
        <fieldset>
            ...
            <p>
                ...
                <label><input type="radio" name="jenis_kelamin" value="laki-laki" value="<?php echo $mapel['jenis_kelamin']
                ?>" />Laki-Laki</label>
                <label><input type="radio" name="jenis_kelamin" value="perempuan" value="<?php echo $mapel['jenis_kelamin']
                ?>" />Perempuan</label>
            </p>
            <p>
